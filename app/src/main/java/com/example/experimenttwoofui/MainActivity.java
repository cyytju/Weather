package com.example.experimenttwoofui;
...
import static com.example.experimenttwoofui.R.id.city_button;
...
//后四天天气
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == Activity.RESULT_OK) {
            ...
            //TextView tv = (TextView) findViewById(R.id.info_left_text);
            //tv.setText(str);
        }
    }
